...
Feature: Touchable Component Validation
  ...
  Scenario: Touchable 02 - Touchable component performs action click on text correctly
        ...
        When I click on touchable text <touchable>
        Then component should render the action attribute correctly
    
  Scenario Outline: Touchable 03 - Touchable component performs action click on image correctly
        And I have an image with <touchable> configured
        When I click on touchable image <touchable>
        Then component should render the action attribute correctly
...
## Snapshot Test
##    Scenario: Touchable 02 - Touchable component renders
