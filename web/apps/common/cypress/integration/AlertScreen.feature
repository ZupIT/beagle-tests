...
Feature: Alert Action Validation
   ...
   #
   # This scenario is not valid for WEB, because there is no title in the alert.
    ...
    Scenario: Alert 03 - The alert should display an action on a confirmation
      ...
      # On the WEB the OK button is already pressed automatically.
   ...
   #
   # This scenario is not valid for WEB, because the text of the alert button is not customized
