...
Feature: Analytics validation
    ...
    Scenario: Analytics 02 - Action with no remote analytics config and declared in the local config (should create record with params in config)
        ...
        # When I press the dialog's OK button 
        Then an analytics record should be created with {"type":"action","platform":"WEB","event":"onPress","component":{"type":"beagle:button","id":"_beagle_5","xPath":"BODY/APP-ROOT[1]/BEAGLE[1]/BEAGLE-REMOTE-VIEW/BEAGLE-SCREEN[17]/BEAGLE-CONTAINER/BEAGLE-BUTTON[4]/","position":{"x":8,"y":26}},"beagleAction":"beagle:confirm","attributes":{"message":"Confirm Message"},"timestamp":1609459200000,"screen":"/analytics2"}
    ...
    Scenario: Analytics 03 - Action with remote analytics config and not declared in the local config (should create record with params from remote config)
        ...
        Then an alert dialog should appear on the screen
        # When I press the dialog's OK button
        Then an analytics record should be created with {"type":"action","platform":"WEB","event":"onPress","component":{"type":"beagle:button","id":"_beagle_6","xPath":"BODY/APP-ROOT[1]/BEAGLE[1]/BEAGLE-REMOTE-VIEW/BEAGLE-SCREEN[17]/BEAGLE-CONTAINER/BEAGLE-BUTTON[12]/","position":{"x":8,"y":98}},"beagleAction":"beagle:alert","attributes":{"message":"AlertMessage"},"timestamp":1609459200000,"screen":"/analytics2"}
    ...
    Scenario: Analytics 05 - View loaded, screen analytics enabled in the config (should create record)
        ...
        Then an analytics record should be created with {"type":"screen","platform":"WEB","timestamp":1609459200000,"screen":"/analytics2-navigate","rootId":"/analytics2-navigate"}
