...
Feature: SetContext Action Validation
    ...
    is triggered setting a hardcoded value on that context
        ...
        Examples:
          ...
          #this test is not applicable on the WEB because mobile and web have different approaches. In this case,
          #the web will not do anything while the mobile will transform the type that was String into Map
